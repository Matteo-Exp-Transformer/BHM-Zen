...
- **Ultimo checkpoint**: CP11 — casa Scorte viva (dec. 12): inventario+giro+spesa RPC verificati live nel browser
- **Prossimo passo**: Regia (setup/controllo, mockup 04) + inviti staff (FU-001 residuo) · icone PWA · report chiusura sessione
