...
- **Ultimo checkpoint**: CP9 — FU-008+FU-009 chiusi: migration storno-trigger APPLICATA, storno manutenzioni in UI, E2E scrittura verde
- **Prossimo passo**: Calendario (definire in `docs/meta/MAPPATURA_AREE/` poi costruire — vista completa mansioni per tutti i ruoli, completamento anticipato dal calendario) · Scorte (mockup 07 + RPC shopping già live) · Regia + inviti staff · icone PWA
